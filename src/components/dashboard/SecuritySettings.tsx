...
import { ShieldCheckIcon, LockClosedIcon, ExclamationCircleIcon } from '@heroicons/react/24/outline';
      ...
      <div className="px-4 py-5 sm:p-6">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-6">
          <div>
            ...
            <div className="mt-1">
              ...
              <p className="mt-1 text-xs text-gray-500">
                Number of days to retain conversation data. After this period, data will be automatically deleted.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="piiFiltering" className="font-medium text-gray-700">PII Filtering</label>
                <p className="text-gray-500">Automatically detect and redact personally identifiable information (PII).</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="endToEndEncryption" className="font-medium text-gray-700">End-to-End Encryption</label>
                <p className="text-gray-500">Enable end-to-end encryption for all conversations (Business and Enterprise plans only).</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="gdprCompliant" className="font-medium text-gray-700">GDPR Compliance Mode</label>
                <p className="text-gray-500">Enable additional features required for GDPR compliance.</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="hipaaCompliant" className="font-medium text-gray-700">HIPAA Compliance Mode</label>
                <p className="text-gray-500">Enable additional features required for HIPAA compliance (Enterprise plan only).</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-gray-200">
            ...
            <p className="mt-1 text-xs text-gray-500">
              Restrict access to your chatbot to specific IP addresses. Leave empty to allow all IPs.
            </p>
          ...
          <div className="pt-6 border-t border-gray-200">
            <h4 className="text-sm font-medium text-gray-900">Sensitive Topics</h4>
            <p className="mt-1 text-xs text-gray-500">
              Define topics that your chatbot should handle with extra care or avoid entirely.
            </p>
