...
export default function FacebookIntegrationModal({
  ...
  const handleConnectFacebook = async () => {
    ...
    try {
      ...
      // window.location.href = `/api/integrations/facebook/oauth?chatbotId=${chatbotId}`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // await fetch(`/api/chatbots/${chatbotId}/integrations/facebook/configure`, {
      //   method: 'POST',
      ...
      setError('Failed to configure Facebook integration. Please check your credentials and try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Connect Facebook Messenger</h3>
        ...
        {step === 1 ? (
          <div>
            <p className="text-sm text-gray-500 mb-6">
              Connect your chatbot to Facebook Messenger to engage with customers directly on Facebook.
            </p>
        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          <h4 className="text-sm font-medium text-gray-900">How to find your Facebook Page ID</h4>
          <ol className="mt-2 text-xs text-gray-500 list-decimal list-inside space-y-1">
            ...
            <li>For the access token, you'll need to create a Facebook App in the Meta for Developers portal</li>
          </ol>
          <p className="mt-2 text-xs text-gray-500">
            Need help? <a href="https://developers.facebook.com/docs/messenger-platform/getting-started" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-500">Read the Facebook Messenger API documentation</a>
          </p>
        </div>
      </div>
    </div>
