...
export default function ShopifyIntegrationModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // await fetch(`/api/chatagents/${chatagentId}/integrations/shopify/configure`, {
      //   method: 'POST',
      ...
      setError(
        "Failed to configure Shopify integration. Please check your credentials and try again."
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="bg-white rounded-lg p-6 max-w-md w-full">
        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          <h4 className="text-sm font-medium text-gray-900">
            How to find your Shopify API credentials
          </h4>
          ...
          <p className="mt-2 text-xs text-gray-500">
            ...
            >
              Read the Shopify API documentation
            </a>
          </p>
        </div>
      </div>
