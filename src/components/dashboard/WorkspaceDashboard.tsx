...
export function WorkspaceDashboard({ workspaceId }: WorkspaceDashboardProps) {
  ...
  useEffect(() => {
    ...
    getAgentByWorkspace();
  }, [user, clearAuth, setAgents, token, workspaceId]);
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div>
        ...
        <RecentActions workspaceId={workspaceId} />
      </div>
          ...
          <TabPanel className="outline-none">
            {agents && agents.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {agents.map((chatagent) => (
                  <AgentCard
                    ...
                    onManage={() =>
                      router.push(
                        `/workspace/${workspaceId}/agent/${chatagent.id}`
                      )
                    }
                  />
                ))}
                ...
                <button
                  onClick={() =>
                    router.push(`/workspace/${workspaceId}/create`)
                  }
              ...
              <div className="text-center py-20">
                ...
                <Button
                  onClick={() =>
                    router.push(`/workspace/${workspaceId}/market`)
                  }
                >
                  Hire Agent
                </Button>
