...
export default function TwilioIntegrationModal({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // await integrationsAPI.configureTwilio(chatbotId, phoneNumber, accountSid, authToken);
      ...
      setError('Failed to configure Twilio integration. Please check your credentials and try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Connect Twilio Phone Number</h3>
        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          <h4 className="text-sm font-medium text-gray-900">How to find your Twilio credentials</h4>
          <ol className="mt-2 text-xs text-gray-500 list-decimal list-inside space-y-1">
            ...
            <li>Purchase a phone number from the Phone Numbers section if you don't have one</li>
          </ol>
        </div>
      </div>
    </div>
