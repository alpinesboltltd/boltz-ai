...
export default function HumanHandoffSettings({
  ...
  initialSettings = {
    enabled: false,
    threshold: 70,
    customMessage: "I'll connect you with a human agent who can help you further.",
    businessHours: {
      enabled: false,
      timezone: 'UTC',
      schedule: [
  ...
  return (
    <div className="bg-white shadow rounded-lg">
      <div className="px-4 py-5 sm:p-6">
        <h3 className="text-lg font-medium leading-6 text-gray-900">Live Human Handoff Settings</h3>
        <p className="mt-1 text-sm text-gray-500">
          Configure when and how your chatbot should transfer conversations to human agents.
        </p>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-6">
          <div className="flex items-start">
            ...
            <div className="ml-3 text-sm">
              <label htmlFor="enabled" className="font-medium text-gray-700">Enable human handoff</label>
              <p className="text-gray-500">When enabled, conversations can be transferred to human agents.</p>
            </div>
          </div>
            ...
            <>
              <div>
                ...
                <div className="mt-1">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Email address to notify when a conversation is transferred to a human agent.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-1">
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    When the AI's confidence falls below this threshold, the conversation will be transferred to a human.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-1">
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    Message displayed to users when transferring to a human agent.
                  </p>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-gray-200">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="businessHoursEnabled" className="font-medium text-gray-700">Enable business hours</label>
                    <p className="text-gray-500">Only transfer to human agents during specified business hours.</p>
                  </div>
                </div>
