...
export default function SlackIntegrationModal({
  ...
  const handleConnectSlack = async () => {
    ...
    try {
      ...
      // window.location.href = `/api/integrations/slack/oauth?chatbotId=${chatbotId}`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // await fetch(`/api/chatbots/${chatbotId}/integrations/slack/configure`, {
      //   method: 'POST',
      ...
      setError('Failed to configure Slack integration. Please check your credentials and try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Connect Slack</h3>
        ...
        {step === 1 ? (
          <div>
            <p className="text-sm text-gray-500 mb-6">
              Connect your chatbot to Slack to provide support and assistance directly in your workspace.
            </p>
            
            <div className="space-y-4">
              <div className="bg-purple-50 p-4 rounded-md">
                <h4 className="text-sm font-medium text-purple-800">Before you connect</h4>
                <ul className="mt-2 text-xs text-purple-700 list-disc list-inside space-y-1">
                  ...
                  <li>Your app needs bot and interactive message permissions</li>
        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          <h4 className="text-sm font-medium text-gray-900">How to find your Slack credentials</h4>
          <ol className="mt-2 text-xs text-gray-500 list-decimal list-inside space-y-1">
            <li>Go to <a href="https://api.slack.com/apps" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-500">api.slack.com/apps</a></li>
            <li>Select your app or create a new one</li>
            <li>For Bot Token: Navigate to "OAuth & Permissions" and find it under "Bot User OAuth Token"</li>
            <li>For Signing Secret: Go to "Basic Information" and find it under "App Credentials"</li>
          </ol>
          <p className="mt-2 text-xs text-gray-500">
            Need help? <a href="https://api.slack.com/bot-users" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-500">Read the Slack Bot documentation</a>
          </p>
        </div>
      </div>
    </div>
