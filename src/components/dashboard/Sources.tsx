    ...
    <div>
      ...
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex space-x-8" aria-label="Tabs">
          ...
          >
            <ShieldQuestionIcon width={20} height={20} />Q & A
          </button>
        </nav>
      </div>
          ...
          <div className="flex flex-col w-3/4 space-y-6">
            <div className="border border-gray-300 px-4 shadow-md rounded-lg py-3 ">
              ...
              <p className="text-wrap text-sm">
                The Files tab allows you to upload and manage various document
                types to train your AI agent. <a href="">Learn more</a>
              </p>
              <div
                onClick={handleDivClick}
                className="flex flex-col border border-gray-500 border-dashed text-sm rounded-lg justify-center items-center py-20 w-full bg-gray-200 my-4 space-y-2"
              >
                <Upload className="w-5" />
                <p className="text-center">
                  Drag & drop files here, or click to select the files
                </p>
                <p className="text-center">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-600 mb-1">
                          <span className="font-sans font-medium text-gray-950">
                            {uploadedFile.name}
                          </span>
                        </p>
            ...
            <div className="border border-gray-300 px-4 shadow-md rounded-lg py-3 space-y-5">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-3">
                  ...
                  Agent with precise information. <a href="">Learn more</a>
                </p>
              </div>
              <div className="flex flex-col gap-y-2">
                ...
                <input
                  ...
                  className="rounded-lg bg-gray-100 border-[0.5px] px-3 py-1 outline-none text-md border-gray-400"
                />
              </div>
        ...
        {activeTab === "website" && (
          <div className="flex flex-col w-3/4">
            <div className="border border-gray-300 px-4 shadow-md rounded-lg py-3 pb-16 space-y-5">
              <h2>Link</h2>
              <p className="text-sm text-gray-500 mt-3">
                Crawl specific web pages or submit sitemaps to continuously
                update your AI with the latest content. Configure included and
                excluded paths to refine what your AI learns.{" "}
                <a href="">Learn more</a>
              </p>
              {/* Website tabs */}
              <div className="border-b border-gray-200">
                <nav
                  className="-mb-px flex items-center space-x-8"
                  aria-label="Tabs"
                >
                  <button
              ...
              {websiteTab === "crawl" && (
                <div className="flex flex-col gap-y-2 mt-4">
                  ...
                  <div className="flex justify-end mt-3">
                    <button className="bg-gray-700 text-gray-100 text-sm font-medium px-2 py-1 rounded-lg">
                      Fetch Link
                    </button>
                  </div>
                </div>
          ...
          <div className="flex flex-col w-3/4">
            <div className="border border-gray-300 px-4 shadow-md rounded-lg py-3 space-y-5">
              <div>
                <h2>Q & A</h2>
                <p className="text-sm text-gray-500 mt-3">
                  Craft responses for important questions, ensuring your AI
                  Agent shares the most relevant info. Use Custom Answers to add
                  images and videos for enhanced engagement.{" "}
                  <a href="">Learn more</a>
                </p>
              </div>
              <div className="flex flex-col gap-y-2">
              ...
              <button
                ...
                className="flex items-center p-2 bg-gray-100 transition ease-in-out hover:bg-gray-400 hover:p-2 hover:rounded-lg"
              >
        ...
        <div className="border border-gray-300 px-4 shadow-md rounded-lg py-3 w-1/3 space-y-6">
          ...
          <div className="flex justify-between">
            <p className="flex items-center text-sm ">
              <File className="w-3" /> 1 File
            </p>
            <p className="text-sm">
              {uploadedFile ? formatBytes(uploadedFile.size) : `7 KB`}
            </p>
          </div>
          ...
          <div className="flex justify-between text-sm">
            ...
            <p className="text-wrap flex flex-col items-end">
              {uploadedFile ? formatBytes(uploadedFile.size) : `7 KB`}{" "}
              <p>/400 KB</p>
            </p>
          </div>

          <p className="bg-black text-white px-3 py-3 rounded-xl text-center border text-sm font-semibold">
            Retrain Agent
          </p>
        </div>
      </div>
