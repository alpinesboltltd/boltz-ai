...
export default function WordPressIntegrationModal({
  ...
  const handleDownloadPlugin = () => {
    ...
    // window.location.href = `/api/integrations/wordpress/download-plugin?chatbotId=${chatbotId}`;
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      // await fetch(`/api/chatbots/${chatbotId}/integrations/wordpress/verify`, {
      //   method: 'POST',
      // });
      ...
      setError('Failed to verify WordPress integration. Please make sure the plugin is installed correctly.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Connect WordPress</h3>
        ...
        {step === 1 ? (
          <div>
            <p className="text-sm text-gray-500 mb-6">
              Connect your chatbot to your WordPress site by installing our plugin.
            </p>
            
            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-md">
                <h4 className="text-sm font-medium text-blue-800">Installation Steps</h4>
                <ol className="mt-2 text-xs text-blue-700 list-decimal list-inside space-y-1">
                  ...
                  <li>Go to Boltz settings in WordPress and enter your chatbot ID: <span className="font-mono bg-blue-100 px-1 rounded">{chatbotId}</span></li>
                </ol>
              </div>
          ...
          <div>
            <p className="text-sm text-gray-500 mb-6">
              Have you installed and activated the plugin on your WordPress site?
            </p>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-4 rounded-md">
                ...
                <p className="mt-2 text-xs text-green-700">
                  Click the button below to verify that the plugin is installed correctly and connected to your chatbot.
                </p>
              </div>
