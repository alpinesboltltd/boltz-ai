...
export function ActionForm({
  ...
  const onSubmit = (data: CustomActionFormData) => {
    onSave({
      ...
      category: "custom",
      triggers: [
        { type: "keyword", value: data.name.toLowerCase(), conditions: {} },
      ],
      steps: [
        {
          id: "1",
  ...
  const actionTypes = [
    ...
    },
    {
      ...
      label: "Follow-up",
      icon: Zap,
      description: "Follow up on customer interactions",
    },
    {
      value: "booking",
      label: "Booking",
      icon: Calendar,
      description: "Handle appointment bookings",
    },
    {
      value: "order",
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-sm text-blue-700">
                Quick actions are simple, single-purpose functions. For complex
                multi-step processes, use the Sequential Workflow builder or
                create API Functions for reusable integrations.
              </p>
            </div>
          </form>
        </div>
