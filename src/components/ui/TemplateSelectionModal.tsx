    ...
    templates: [
      {
        ...
        name: "Sarah",
        category: "business",
        description: "Your friendly customer support specialist who handles inquiries with warmth and efficiency",
        icon: "👩‍💼",
        badge: "popular",
        features: [
        ...
        config: {
          ...
          welcome_message: "Hi there! I'm Sarah 👋 I'm here to make sure you have the best experience possible. What can I help you with today?",
          suggested_messages: [
            "Track my order",
            "Return policy",
            "Contact support",
          ...
          fallback_message: "That's a great question! Let me connect you with one of my teammates who specializes in this area. They'll be able to help you right away.",
          temperature: 0.6,
          max_tokens: 500,
      ...
      },
      {
        ...
        name: "Ben",
        category: "business",
        description: "Energetic sales expert who helps customers discover perfect products and close deals",
        icon: "👨‍💼",
        badge: "recommended",
        features: [
        ...
        useCase: "Perfect for: Online stores, SaaS companies, Service providers",
        config: {
          agent_type: AgentType.TEXT,
          ai_model: "gpt-3.5-turbo",
          ai_provider: "OpenAI",
          ...
          welcome_message: "Hey there! Marcus here 🌟 I'd love to help you find exactly what you need. What brings you in today?",
          suggested_messages: [
            "See pricing",
            "Compare plans",
            "Book a demo",
          ...
          fallback_message: "Great question! Let me get you connected with our product specialist who can dive deeper into those details.",
          temperature: 0.7,
          max_tokens: 500,
      ...
      },
      {
        ...
        name: "Alex",
        category: "business",
        description: "Strategic business consultant who qualifies leads through natural, engaging conversations",
        icon: "🎯",
        features: [
          "Smart questioning",
          "Contact collection",
        ...
        config: {
          ...
          welcome_message: "Hi! I'm Alex 👋 I help businesses like yours find the right solutions. I'd love to learn more about what you're working on - mind if I ask a few questions?",
          suggested_messages: [
          ...
          fallback_message: "I'd love to get you more detailed information. Could I grab your email so our team can send over some tailored resources?",
          temperature: 0.6,
          max_tokens: 400,
    ...
    templates: [
      {
        ...
        name: "Patricia",
        category: "healthcare",
        description: "Compassionate healthcare advisor specializing in Medicare plans and coverage options",
        icon: "👩‍⚕️",
        badge: "new",
        features: [
        ...
        config: {
          ...
          welcome_message: "Hello, I'm Dr. Williams 👋 I'm here to help you understand your Medicare options in plain English. What questions do you have?",
          suggested_messages: [
          ...
          fallback_message: "That's a really important question for your specific situation. I'd recommend speaking with one of our licensed Medicare advisors who can give you personalized guidance. Shall I connect you?",
          temperature: 0.4,
          max_tokens: 600,
      ...
      },
      {
        ...
        name: "Timi",
        category: "healthcare",
        description: "Friendly medical scheduler who makes booking appointments quick and hassle-free",
        icon: "👨‍⚕️",
        features: [
          "Appointment booking",
          "Reminder sending",
        ...
        config: {
          ...
          welcome_message: "Hi! I'm Jamie from the scheduling team 😊 I'll help you get an appointment set up. What type of visit do you need?",
          suggested_messages: [
            "Book appointment",
            "Reschedule visit",
            "Cancel appointment",
    ...
    templates: [
      {
        ...
        category: "education",
        description: "Inspiring educator who makes learning fun and helps students truly understand concepts",
        icon: "👩‍🏫",
        badge: "popular",
        features: [
        ...
        config: {
          ...
          welcome_message: "Hey there! I'm Professor Patel 📚 but you can call me Maya! What subject are we tackling today? I promise to make it interesting!",
          suggested_messages: [
          ...
          fallback_message: "What a great question! Let's break this down together, step by step...",
          temperature: 0.8,
          max_tokens: 600,
      ...
      },
      {
        ...
        name: "Bolsnle",
        category: "education",
        description: "Experienced academic counselor who helps students map out their educational journey",
        icon: "👨‍🎓",
        features: [
        ...
        config: {
          ...
          welcome_message: "Hi, I'm Bolanle! 🎓 I'm here to help you plan your academic journey. Let's chat about your interests and goals - what excites you?",
          suggested_messages: [
            "Course recommendations",
          ...
          fallback_message: "That's an excellent question! Let me help you explore all your options...",
          temperature: 0.7,
          max_tokens: 500,
          primary_color: "#8b5cf6"
        }
    ...
    templates: [
      {
        ...
        name: "Emma",
        category: "ecommerce",
        description: "Personal stylist and shopping expert who loves helping customers find their perfect items",
        icon: "👗",
        badge: "popular",
        features: [
          "Product discovery",
        ...
        config: {
          ...
          welcome_message: "Hey love! I'm Emma ✨ Your personal shopping buddy! What are we looking for today? I'm SO excited to help!",
          suggested_messages: [
          ...
          fallback_message: "Ooh, great taste! Want to see similar items or should we add this beauty to your cart?",
          temperature: 0.7,
          max_tokens: 500,
      ...
      },
      {
        ...
        name: "Chris",
        category: "ecommerce",
        description: "Reliable logistics specialist who tracks down packages and solves delivery issues fast",
        icon: "📦",
        features: [
          "Order status",
          "Tracking updates",
        ...
        config: {
          ...
          welcome_message: "Hi there! I'm Chris 📦 I'll help you track down your order. Just give me your order number or email, and I'll get you the latest info!",
          suggested_messages: [
            "Track my order",
            "Where's my package?",
          ...
          fallback_message: "I'm pulling up your order details right now. Give me just a moment...",
          temperature: 0.5,
          max_tokens: 400,
                          ...
                          <div>
                            ...
                            {template.badge && (
                              <span className={`inline-block text-xs font-medium px-2 py-0.5 rounded-full mt-1 ${
                                template.badge === "popular" ? "bg-blue-100 text-blue-700" :
                                template.badge === "new" ? "bg-green-100 text-green-700" :
                                "bg-purple-100 text-purple-700"
                              }`}>
                                {template.badge === "popular" ? "🔥 Popular" :
