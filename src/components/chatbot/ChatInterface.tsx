...
export default function ChatInterface({
  ...
  const getAvatarContent = () => {
    ...
    if (avatarStyle === 'custom' && avatarImage) {
      return <img src={avatarImage} alt="Bot avatar" className="h-full w-full object-cover" />;
    }
  ...
  return (
    ...
    >
      ...
      >
        {messages.map((message) => (
          ...
          >
            ...
            <div
              ...
              style={{ 
                backgroundColor: message.sender === 'user' ? darkModeStyles.userMessage : undefined 
              }}
            >
        ...
        {isTyping && (
          <div className="flex justify-start mb-4">
            ...
            <div className={`px-4 py-2 rounded-lg ${darkModeStyles.botMessage}`}>
      ...
      {/* Chat Input */}
      <form onSubmit={handleSendMessage} className={`p-3 border-t ${darkMode ? 'border-gray-700' : 'border-gray-200'} ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
        <div className="flex items-center">
          <VoiceRecorder 
