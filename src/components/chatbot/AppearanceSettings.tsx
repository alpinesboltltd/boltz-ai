                ...
                <div className="flex items-center space-x-4">
                  <div 
                    className={`flex items-center justify-center h-12 w-12 rounded-full cursor-pointer ${
                      settings.avatarType === 'default' ? 'ring-2 ring-primary-500' : 'ring-1 ring-gray-200'
                    }`}
                  ...
                  <div 
                    className={`flex items-center justify-center h-12 w-12 rounded-full cursor-pointer ${
                      settings.avatarType === 'none' ? 'ring-2 ring-primary-500' : 'ring-1 ring-gray-200'
                    }`}
                  ...
                  <div 
                    className={`flex items-center justify-center h-12 w-12 rounded-full cursor-pointer overflow-hidden ${
                      settings.avatarType === 'custom' ? 'ring-2 ring-primary-500' : 'ring-1 ring-gray-200'
                    }`}
                    onClick={() => avatarFileRef.current?.click()}
                  >
                    {settings.avatarImage ? (
                      <img src={settings.avatarImage} alt="Custom avatar" className="h-full w-full object-cover" />
                    ) : (
                      <span className="text-2xl">📷</span>
                    )}
                  </div>
            ...
            <div>
              ...
              <div className="mt-2 space-y-3">
                <div className="flex items-center space-x-4">
                  <div 
                    className={`flex items-center justify-center h-12 w-12 rounded-full cursor-pointer ${
                      settings.bubbleIcon === 'default' ? 'ring-2 ring-primary-500' : 'ring-1 ring-gray-200'
                    }`}
                  ...
                  <div 
                    className={`flex items-center justify-center h-12 w-12 rounded-full cursor-pointer overflow-hidden ${
                      settings.bubbleIcon === 'custom' ? 'ring-2 ring-primary-500' : 'ring-1 ring-gray-200'
                    }`}
                    onClick={() => bubbleIconFileRef.current?.click()}
                  >
                    {settings.bubbleIconImage ? (
                      <img src={settings.bubbleIconImage} alt="Custom bubble icon" className="h-full w-full object-cover" />
                    ) : (
                      <span className="text-2xl">📷</span>
                    )}
                  </div>
              ...
              <div className="mt-2 flex items-center space-x-4">
                <div 
                  className={`flex items-center justify-center h-12 w-24 rounded cursor-pointer ${
                    settings.position === 'bottom-right' ? 'bg-primary-100 border-2 border-primary-500' : 'bg-gray-100 border border-gray-300'
                  }`}
                ...
                <div 
                  className={`flex items-center justify-center h-12 w-24 rounded cursor-pointer ${
                    settings.position === 'bottom-left' ? 'bg-primary-100 border-2 border-primary-500' : 'bg-gray-100 border border-gray-300'
                  }`}
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full max-h-[90vh] overflow-hidden">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-medium text-gray-900">Chat Preview</h3>
              <button
                type="button"
            ...
            <div className="h-[600px] border border-gray-200 rounded-lg">
              <ChatInterface
                ...
                avatarStyle={settings.avatarType === 'custom' ? 'custom' : settings.avatarType === 'none' ? 'none' : 'default'}
