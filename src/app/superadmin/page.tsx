...
const DefaultPrompts = () => {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<CreatePromptTemplateRequest>({
    ...
    <div className="p-6 space-y-6">
      ...
      {isCreating && (
        <form
          ...
          className="bg-gray-50 p-4 rounded-xl space-y-4 border border-gray-200"
        >
          <div>
            <Input
              label="Title"
...
const AIProviders = () => {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<CreateAIModelFormValues>({
  ...
  const fetchModels = async () => {
    setIsLoading(true);
    try {
      const res = await aiModelsAPI.getAll(
...
const CostSettings = () => (
  <div className="p-6 text-center text-gray-500">
    Cost & Token settings implementation pending backend support.
  </div>
);
const DefaultAgents = () => (
  <div className="p-6 text-center text-gray-500">
    Default Agent creation implementation pending backend support.
  </div>
);
