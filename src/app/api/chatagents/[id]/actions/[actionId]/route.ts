      ...
      if (mockData.custom_actions) {
        ...
        if (actionIndex !== -1) {
          mockData.custom_actions[actionIndex].status =
            mockData.custom_actions[actionIndex].status === "active"
              ? "inactive"
              : "active";
          mockData.custom_actions[actionIndex].updated_at =
      ...
      if (!actionFound && mockData.system_actions) {
        ...
        if (actionIndex !== -1) {
          mockData.system_actions[actionIndex].status =
            mockData.system_actions[actionIndex].status === "active"
              ? "inactive"
              : "active";
          mockData.system_actions[actionIndex].updated_at =
            new Date().toISOString();
          actionFound = true;
        }
      }
