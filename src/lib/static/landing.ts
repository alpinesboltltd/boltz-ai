...
export const testimonials: Testimonial[] = [
  {
    content:
      "Level-x Ai transformed our customer support. We reduced response times by 80% and increased satisfaction by 35%.",
...
export const enterpriseFeatures: EnterpriseFeature[] = [
  ...
  },
  {
    ...
    description:
      "Enterprise-grade security with custom compliance requirements",
  },
  {
